...
public class B {
    ...
    @Timeout(1)
    void test(int[] NM, int[][] in, int[][] out) throws Exception {
//        int[][] result = getResult(NM, in);
...
//        }
    ...
    private static void getResult(int[] NM, int[][] in) throws Exception {
