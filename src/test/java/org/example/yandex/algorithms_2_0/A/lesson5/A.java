...
public class A {
    ...
    public static void main(String[] args) throws Exception {
        ...
        fs.next();
        int[] d = fs.readStringAsIntArray();
        fs.writeAll(getResult(a, b, c, d), ' ');
    ...
    @Timeout(1)
    void test(int[] a, int[] b, int[] c, int[] d, int[] out) throws Exception {
        assertArrayEquals(out, getResult(a, b, c, d));
    }
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                ...
                Arguments.of(
                        new int[]{1, 2, 3, 4, 5, 6},
                        new int[]{2, 10, 256, 4},
                        new int[]{111, 255, 4, 3, 656, 5},
                        new int[]{134343, 5435345, 23123, 5, 5, 4, 21345},
                        new int[]{4, 4, 4, 4}
                ),
                Arguments.of(
                        ...
                        new int[]{1,1,1,10},
                        new int[]{5,3,7,8,10},
                        new int[]{134343, 5435345, 23123, 5, 5, 4, 10},
                        new int[]{10,10,10,10}
                ),
                Arguments.of(
                        new int[]{1,1,1,10},
    ...
    private static int[] getResult(int[] a, int[] b, int[] c, int[] d) {
        ...
        int cres = c[idxc];
        int dres = d[idxd];
        while (idxa < a.length && idxb < b.length && idxc < c.length && idxd < d.length) {
            int shiftidx = 0;
            int ael = a[idxa];
            int bel = b[idxb];
            int cel = c[idxc];
        ...
        return new int[]{ares, bres, cres, dres};
    }
