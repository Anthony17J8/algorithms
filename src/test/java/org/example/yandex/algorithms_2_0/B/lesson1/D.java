...
package org.example.yandex.algorithms_2_0.B.lesson1;
...
public class D {
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                ...
                Arguments.of(new int[]{-10, 0, 1, 6}, 1),
    ...
    private static int getResult(int[] arr) {
        if (arr.length % 2 != 0) {
            ...
            int el1 = arr[arr.length / 2];
            int el2 = arr[arr.length / 2 - 1];
            BigDecimal bi1 = new BigDecimal(String.valueOf(el1));
            BigDecimal bi2 = new BigDecimal(String.valueOf(el2));
            return bi1.add(bi2).divide(new BigDecimal("2"), RoundingMode.HALF_UP).intValue();
        }
    }
