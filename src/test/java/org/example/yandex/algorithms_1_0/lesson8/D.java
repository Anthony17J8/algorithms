...
public class D {
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                Arguments.of(new int[]{7, 3, 2, 1, 9, 5, 4, 6, 8, 0}, new int[]{1, 2, 3, 4, 5, 6, 7, 8, 9}),
                Arguments.of(
                        new int[]{4, 2, 4, 6, 2, 4, 1, 6, 2, 4, 3, 1, 6, 2, 4, 5, 3, 1, 6, 2, 4, 7, 5, 3, 1, 6, 2, 4, 0},
                        new int[]{1, 2, 3, 4, 5, 6, 7}),
                Arguments.of(new int[]{2, 1, 0}, new int[]{1, 2}),
