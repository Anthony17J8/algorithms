...
public class H {
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                Arguments.of(new int[]{7, 3, 2, 1, 9, 5, 4, 6, 8, 0}, YES),
                Arguments.of(new int[]{1, 2, 3, 4, 5, 6, 7, 0}, NO),
                Arguments.of(new int[]{1, 2, 0}, YES),
                Arguments.of(new int[]{1, 2, 3, 0}, NO),
                Arguments.of(new int[]{2, 1, 3, 0}, YES),
                Arguments.of(new int[]{2, 1, 3, 0}, YES),
                Arguments.of(new int[]{10, 15, 8, 9, 5, 2, 12}, YES),
                Arguments.of(new int[]{1, 0}, YES)
        );
    }
    ...
    private static int h(Tree tree, Integer nodeIdx) {
        if (nodeIdx == null) {
            return 0;
        }
        if (tree.elements[nodeIdx][2] == null && tree.elements[nodeIdx][3] == null) {
            return 1;
        }

        int hleft = h(tree, tree.elements[nodeIdx][2]);
        int hright = h(tree, tree.elements[nodeIdx][3]);
