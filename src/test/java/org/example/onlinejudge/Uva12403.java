...
public class Uva12403 {
    ...
    static String donate = "donate", report = "report";
    ...
    public static void main(String[] args) throws Exception {
        ...
        int t = fs.nextInt();
        while (t-- > 0) {
            String[] split = fs.next().split(" ");
            if (split.length == 1 && split[0].equals(report)) {
                sb.append(total)
                        .append("\n");
            } else if (split.length == 2 && split[0].equals(donate)) {
