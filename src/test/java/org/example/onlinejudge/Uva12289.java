...
public class Uva12289 {
    ...
    static String good = "good", bad = "bad";
    static int _20 = 20;
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (t > 0) {
            sb
                    ...
                    .append(getResult(fs.readStringAsIntArray()))
                    .append("\n");
            t--;
            idx++;
        }
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                Arguments.of(new int[]{20, 20, 20}, good),
                Arguments.of(new int[]{1, 2, 21}, bad),
                Arguments.of(new int[]{1, 2, 2}, good),
                Arguments.of(new int[]{50, 50, 50}, bad)
        );
    }

    private static String getResult(int[] in) {
        return in[0] <= _20 && in[1] <= _20 && in[2] <= _20 ? good : bad;
    }
