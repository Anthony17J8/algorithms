...
public class Uva12279 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while ((n = fs.nextInt()) != 0) {
            ...
            sb.append("Case ").append(idx).append(": ")
                    .append(getResult(l.stream().mapToInt(Integer::valueOf).toArray()))
                    .append("\n");
            idx++;
        }
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                Arguments.of(new int[]{3, 4, 0, 0, 1}, 1),
                Arguments.of(new int[]{2, 0, 0, 0}, -2),
                Arguments.of(new int[]{1, 2, 3, 4, 5, 0, 0}, 3)
        );
    }
