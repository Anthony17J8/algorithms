...
public class Task1080A {
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                Arguments.of(new int[]{1, 7, 6, 7, 67}, YES),
                Arguments.of(new int[]{1, 3, 5, 7, 8}, NO),
                Arguments.of(new int[]{1, 67}, YES),
                Arguments.of(new int[]{1,}, NO)
        );
    }
