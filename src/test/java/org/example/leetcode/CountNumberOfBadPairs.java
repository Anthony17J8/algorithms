...
//        assertEquals(out, getResult(text, k));
    ...
    private static long getResult(int[] nums) {
        // определять неубывающие последовательности
        // начиная с какого-то элемента с последующим  должна всегда увеличивать на 1
        //
        return 0l;
    }
